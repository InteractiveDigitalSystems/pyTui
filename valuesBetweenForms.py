"""
Modified from https://stackoverflow.com/a/54999235
"""
...
class EmployeeConfirmForm(npyscreen.ActionForm):
    ...
    def create(self):
        ...
        self.wgName = self.add(npyscreen.TitleText,
                               name="Name:", editable=False)
        self.wgDept = self.add(npyscreen.TitleText,
                               name="Dept:", editable=False)
        self.wgEmp = self.add(npyscreen.TitleText,
                              name="Employed:", editable=False)
